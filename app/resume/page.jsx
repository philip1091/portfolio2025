          ...
          <div className="min-h-[70vh] w-full">
                  ...
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                    {experience.items.map((item, index) => {
                      return (
                        <li
                          key={index}
                          className="bg-[#232329] h-[184px] py-6 px-10 rounded flex flex-col justify-center items-center lg:items-start gap-1"
                        >
            ...
            <TabsContent value="skills" className="w-full">
              <div className="flex flex-col gap-[30px]">
                ...
                <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:gap-[30px] gap-5 mb-10">
            ...
            >
              <div className="flex flex-col gap-[30px]">
                ...
                <ul className="grid grid-cols-1 xl:grid-cols-2 gap-y-10 max-w-[620] mx-auto xl:mx-0">
