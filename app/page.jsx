        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          ...
          {/* <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <h1 className="h1 mb-6">
              Hello I'm
              <br />
              <span className="text-accent">Philip Hicintuka</span>
            </h1>
            <TypingAnimation as="p" className="text-md max-w-[500px] mb-9 text-white/80">
          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <div className="text-xl mb-9">
              ...
              <span className="text-center text-md max-w-[500px]  text-white/80">
                who excels at crafting elegant digital experiences and I am
                proficient in various programming languages and technologies.
              </span>
            </div>
